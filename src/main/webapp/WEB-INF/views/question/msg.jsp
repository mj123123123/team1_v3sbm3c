  ...
  <fieldset class='fieldset_basic'>
    <UL>
      ...
      <li class='li_none'>
        ...
        <button type='button' onclick="location.href='./create.do?questno=${questno}'" class="btn btn-dark btn-sm">새로운 질문 등록</button>
        <button type='button' onclick="location.href='./list_all.do?'" class="btn btn-dark btn-sm">목록</button>
        <button type='button' onclick="location.href='./list_by_tcateno.do?tcateno=${tcateno}'" class="btn btn-dark btn-sm">카테고리 별 질문 목록</button>
      </li>
    </UL>
  </fieldset>
