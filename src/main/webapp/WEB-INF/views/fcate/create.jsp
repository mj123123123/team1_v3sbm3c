...
<title>http://localhost:9093/fcate/create.do</title>
...
<body>
	...
	<form name='frm' method='post' action='/fcate/create.do'>
		<div>
			<label>카테고리 이름</label>
			<input type="text" name="name" value="" required="required" autofocus="autofocus" class="form-control form-control-sm" style="width: 50%">
		</div>
